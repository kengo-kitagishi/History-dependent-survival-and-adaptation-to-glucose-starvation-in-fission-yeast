...
The relative difference between the theoretical and experimental values is
\begin{equation}
\frac{|k_{\mathrm{theory}}^{\mathrm{off-axis}} - k_{\mathrm{exp}}^{\mathrm{off-axis}}|}{k_{\mathrm{theory}}^{\mathrm{off-axis}}} = \frac{|3.02 - 3.01|}{3.02} \times 100\% = 0.3\%.
\end{equation}
