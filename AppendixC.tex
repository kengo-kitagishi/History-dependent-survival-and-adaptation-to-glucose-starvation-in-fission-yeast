\chapter{マイクロ流路デバイス作製の詳細手順}
\label{appendix:microfluidic_protocol}

\section{Scope and device revision}
...
\section{Design files and critical dimensions}
...
\section{Photomask and alignment specification}
\begin{itemize}
...
\section{Master mold fabrication (two-layer SU-8)}
...
\subsection{Layer 1: observation channel layer}
\textbf{Action}
\begin{enumerate}
...
\subsection{Layer 2: drain layer}
\textbf{Action}
\begin{enumerate}
...
\section{PDMS casting, porting, and bonding}

\subsection{PDMS casting and demolding}
\begin{enumerate}
...
\subsection{Cover glass cleaning}
\begin{enumerate}
...
\section{Epoxy replica master fabrication}
\begin{enumerate}
...
\section{Document control and version history}
